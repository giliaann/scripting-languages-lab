...
class Measurements:
    ...
    ) -> dict[tuple[str, str, str, datetime, datetime], list[str]]:
        """
...
if __name__ == "__main__":
    ...
    # print(
    #     [f"| {x.indicator_name}, {x.station_code}, {x.mean:.2} {x.unit} |" for x in ms.get_by_parameter(measurand)[:5]]
    # )
    # print("-" * 20)
    # code = "DsJelGorOgin"
    ...
    # print("-" * 20)
# 
    series_validators = [ZeroSpikeDetector(), OutlierDetector(5.0), ThresholdDetector(90.0)]
    # n = 3
    # m = 5
    ts_to_anomalies = ms.detect_all_anomalies(series_validators, True)
    pprint(ts_to_anomalies)
# 
